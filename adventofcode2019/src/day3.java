        ...
        for (int i = 0; i < fstValues.length; i++){
            ...
            if (fstValues[i].contains("L")){
                ...
                for(int j = 0; j < nLeft; j++){
                    ...
                    fstPairCoordinates.add(leftCoordinates);
                }
            }

            else if (fstValues[i].contains("R")){
                for (char ch : fstValues[i].toCharArray()){
                    if(Character.isDigit(ch)){
                        temp = temp + ch;
                    }
                ...
                for(int j = 0; j < nRight; j++){
                    ...
                    fstPairCoordinates.add(rightCoordinates);
                }
            }

            else if (fstValues[i].contains("D")){
                for (char ch : fstValues[i].toCharArray()){
                    if(Character.isDigit(ch)){
                        temp = temp + ch;
                    }
            ...
            else if (fstValues[i].contains("U")){
                for (char ch : fstValues[i].toCharArray()){
                    if(Character.isDigit(ch)){
                        temp = temp + ch;
                    }
