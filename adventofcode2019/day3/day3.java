...
public class day3 {
    public static void main(String[] args) {
        ...
        List<Pair> fstPairCoordinates = {[fstCoordinates]};
        ...
        for (int i = 0; i < fstValues.length; i++){
            if (fstValues[i].contains("U")){
                ...
                for(int j = 0; j < nLeft; j++){
                    Pair<Integer, Integer> leftCoordinates = new Pair<Integer, Integer>(-j, 0);
                    fstCoordinates = fstCoordinates.add(leftCoordinates);
                    //alla nummer innan nästa kommatecken ska uppåt (alla koordinater ska med i en lista)
                }
            ...
            else if (fstValues[i].contains("L")){
        ...
        //använd listan med koordinater för att hitta intersection (Contains).
